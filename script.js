...
const monthNames = [
  ...
  // Used the try-catch block to handle errors
const getWeatherData = async () => {
  try {

    const city = searchInput.value || 'Phoenix'
    ...
    //pass that data into the updateDom() function
    updateDom(data)
  } catch (error) {
    console.log(error)
  }
...
// a function that returns a cardinal direction based on the degree passed in
